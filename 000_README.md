...
1. Research Scientist & Machine Learning Engineer มี Median และ P90 ในมุมของพนักงานจะสะท้อนความมาแรงของตลาด AI ที่บริษัทยอมจ้างในอัตราที่สูง
2. AI Engineer มี Median กับ P90 กว้างมาก ถ้าเข้าสาย Big Tech หรือ AI Company มีโอกาสทะลุไปกลุ่มเงินเดือนสูงได้
...
**สรุปจาก Insight ในมุมมองรายได้อย่างเดียว**
- Data Scientist อาจไม่ใช่งานที่ “sexy” ที่สุดแล้ว เพราะกระแสการจ้างงาน และความต้องการในตลาดแรงงาน กำลังขยับไปที่ Research Scientist, ML Engineer และ AI Engineer
ซึ่งได้ทั้ง รายได้สูง ติด Top 10% ของตลาด


##
****Focus on posting jobs 2024****

ในเมื่อ ตำแหน่งงานสาย date scinece และ AI ยังคงเป็นตำแหน่งงานที่ยังน่าสนใจอยู่ เรา Focus กันที่ตำแหน่งงานในปี 2024 และ ค่าครองชีพปี 2023 ในช่วงปลายปีมาดูกันว่า 
เรายังจะอยู่รอดกันหรือไม่

****Graph 6 : Job Demand by State****
...
##
****Graph 7 : Average Salary by State and Job Category****
...
##
****Graph 8 : Average Salary by RPP ((Salary x 100)/COLI)****

การดูเงินเดือนเปล่า ๆ อาจจะไม่สามารถตอบได้ว่า จะอยู่รอดหรือไม่ แต่ต้องพิจารณาว่าค่าตอบแทนที่ได้จะ ‘เหลือจริง’ เท่าไรหลังหักค่าครองชีพ”

<img width="1407" height="1265" alt="image" src="https://github.com/user-attachments/assets/bdfbd248-73b5-4838-8e98-814000bb4cfa" />

<img width="1578" height="678" alt="image" src="https://github.com/user-attachments/assets/0bac3cb2-ff9a-4a77-bc4d-5e484fcd2765" />


เมื่อเทียบค่าค่าครองชีพกับอัตราเงินเดือนที่ได้รับของตำแหน่ง Data Science โดยเรียงจาก Cost Of liveing สูงสุด พบว่า รัฐที่มีอััตราค่าครองชีพสูง เช่น MA, DC, CA, NY จะเห็น กว่า RPP หรือกราฟเส่้นสีส้มต่ำกว่าน้ำเงินชัด มันบ่งบอกว่า เงินเดือนสูงก็จริงแต่ค่าครองชีพก็สูงตามไปด้วย เงินที่จะเหลือเก็บได้น้อยลง
แต่หากดูรัฐที่มีค่าครองชีพต่ำลงมาVA, PA, UT, NC เป็นต้น ค่าครองชีพกับเงินเดือนพอๆๆกัน นั่นหมายถือ ค่าใช้จ่ายจับต้องได้มากขึ้น ทำให้มีเงินเหลือจริงดีขึ้น
...
##
******Graph 9 : Average Salary by Industry Group******
...
ถ้ามองแค่ค่าเฉลี่ย เราอาจคิดว่าแต่ละอุตสาหกรรมต่างกันไม่มาก แต่กราฟกระจายเงินเดือน บอกเล่าเรื่องที่ลึกกว่านั้น
...
##
****Graph 10 : Average Salary by Size of company****
...
พบว่า ขนาด Size ที่อัตราผลตอบแทนในแต่ละอุตสาหกรรมมีความแตกต่างกัน โดยขนาดเล็กมีการจ่ายผลตอบแทนที่มีขนาดกว่าขนาดใหญ่ และบริษัทขนาดมีขนาดที่ตำ่อยู่เล็กน้อย ในมุมมองการตีความจากข้อมูล บ่งบอกว่า ขนาดบริษัทไม่ใช่ตัวแปรหลักเพียงอย่างเดียว อาจจะมีปัจจัยอื่นๆ (เช่น Cost of living, Skill, Industry etc) ในการกำหนดอัตราผลตอบแทนแต่ละตำแหน่งรวมด้วย 

##
****Graph 11 : Skill Demand by Industry Group****

<img width="1264" height="590" alt="image" src="https://github.com/user-attachments/assets/7266d6e3-96d5-4a63-bac5-41bf761c9881" />

“จาก heatmap เราจะเห็นว่า สีที่เข้มที่สุด ในหลาย ๆ แถว (อุตสาหกรรม) มักไปตกอยู่ที่ทักษะบางกลุ่ม เช่น Python, SQL, Communication และ machine learning skill นี่เป็นสัญญาณชัดเจนว่า ทักษะเหล่านี้คือ core skill ของสาย Data — ไม่ว่าคุณจะอยู่ในอุตสาหกรรมไหนก็ตาม ต้องใช้แน่นอน
...
##
****Graph 12 :Average Salary by Rating****

  ข้อมูลจากคะแนน Rating บน Glassdoor คือ คะแนนที่ให้โดยพนักงานปัจจุบันและอดีตพนักงาน ของบริษัทนั้นๆ โดยเป็นการให้คะแนนแบบไม่ระบุตัวตน (Anonymous) เพื่อให้ผู้รีวิวสามารถแสดงความคิดเห็นได้อย่างอิสระ โดยจะอยู่ในช่วง 1-5 ดาว จาก Rating ทั้งหมดได้นำมาจัด Group 3 ช่วง ได้แก่ ระดับคะแนน 1-2.9 คือ ระดับน้อย 3-3.9 คือระดับปานกลาง ระดับ 4-5. คือระดับดีมาก จากข้อมูลการจ้างงานในระดับงาน Mid Level มีจำนวนการจ้างงานที่มากที่สุด จึงนำมาวิเคราะห์ดังต่อไปนี้

<img width="1477" height="784" alt="image" src="https://github.com/user-attachments/assets/ed859bc0-62b6-45cb-b53f-5d3c7d528f3e" />

  พบว่า ในแต่ละระดับทั้ง 3 ช่วงของ Rating มีค่าจ้างในแต่ละประเภทของงานอยู่ในระดับใกล้เคียงกัน เงินเดือนในแต่ละระดับของ Rating ไม่ได้แตกต่างกันมากนัก เนื่องจากต้องพิจารณาจากปัจจัยอื่นๆ ได้แก่ ด้าน Work-Life Balance , วัฒนธรรมองค์กร, ความมีชื่อเสียงขององค์กร และสวัสดิการ เป็นต้น
##
...
<img width="1484" height="884" alt="image" src="https://github.com/user-attachments/assets/991100fd-b3b9-4a7e-b9e9-60b85af42b87" />
  ...
  หลังจากได้วิเคราะห์ได้เห็นภาพรวมของ Rating ที่มีผลกับเงินเดือนในแต่ละสายงาน Data แล้ว จึงได้นำมาวิเคราะห์ต่อในเฉพาะสายงาน Data Scientist กับขนาดของบริษัท เพื่อให้เป็นข้อมูลประกอบตัดสินใจว่า ขนาดของบริษัทได้แก่ กลุ่มขนาดเล็กไปจนถึงขนาดใหญ่ จากจำนวนพนักงานตั้งแต่1-10,000 คนเป็นต้นไป ให้เงินเดือนเป็นอย่างไรและ Rating ในกลุ่มใด จากกราฟที่…. แสดงให้เห็นว่า
1.บริษัทระดับกลาง(จำนวนพนักงาน 1001-5000 คน)ได้รับ Rating ระดับดีมาก และให้เงินเดือนสูงสุดที่ 132K และ มีจำนวนในระดับ Rating น้อยในปริมาณที่ต่ำ แสดงให้เห็นว่าบริษัทขนาดกลางเป็นที่นิยม
...
##
Summary 
Insight 1 : Data Science ยังเป็นตำแหน่งที่ยังน่าสนใจอยู่่หรือไม่
Insight 2 : 
